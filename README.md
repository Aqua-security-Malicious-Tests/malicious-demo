...
2. **Add secrets** in repo settings:
   - `AQUA_KEY` - Your Aqua API key
   - `AQUA_SECRET` - Your Aqua API secret
...
**Main branch**: Clean baseline (express + react)

**PR branch** (`test/add-malicious-packages`): Adds malicious packages:
